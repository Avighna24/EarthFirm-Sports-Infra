      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12 flex justify-start">
          <button
            ...
            className="flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-zinc-200 hover:border-zinc-400 text-xs font-mono tracking-widest uppercase transition-all duration-300 hover:bg-zinc-50 text-zinc-600 hover:text-zinc-900 cursor-pointer active:scale-95"
          >
        ...
        >
          <span className="text-xs uppercase tracking-[0.25em] text-emerald-600 font-mono font-bold block mb-4">
            {language === 'hi' ? 'हमारा इतिहास और दर्शन' : 'Our Legacy & Vision'}
          </span>
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight uppercase text-zinc-900 leading-tight">
            About EarthFirm
          </h1>
          <p className="text-zinc-600 text-sm sm:text-lg max-w-2xl mx-auto mt-4 leading-relaxed font-mono">
            {language === 'hi'
        ...
        >
          <motion.div variants={staggerItem} className="space-y-6">
            <div className="border-l-2 border-emerald-500 pl-6 space-y-4">
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-zinc-900">
            ...
            <p className="text-zinc-600 text-sm sm:text-base leading-relaxed pl-6">
              {language === 'hi'
          ...
          <motion.div variants={staggerItem} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-5 hover:border-emerald-500/30 transition-all duration-300">
                <Trophy className="h-6 w-6 text-emerald-600 mb-3" />
                <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-900">Premium Quality</h4>
              ...
              <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-5 hover:border-emerald-500/30 transition-all duration-300">
                ...
                <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-900">Guaranteed Trust</h4>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-24 border-y border-zinc-200 py-10"
        >
          <motion.div variants={staggerItem} className="text-center">
            <p className="text-4xl sm:text-5xl font-black text-zinc-900 font-mono tracking-tight">100%</p>
            <p className="text-zinc-500 font-mono uppercase text-[10px] sm:text-xs tracking-wider mt-2">Durable Civil Quality</p>
          </motion.div>
          <motion.div variants={staggerItem} className="text-center">
            <p className="text-4xl sm:text-5xl font-black text-zinc-900 font-mono tracking-tight">ITF/FIBA</p>
            <p className="text-zinc-500 font-mono uppercase text-[10px] sm:text-xs tracking-wider mt-2">Standard Surfacing</p>
          </motion.div>
          <motion.div variants={staggerItem} className="text-center">
            <p className="text-4xl sm:text-5xl font-black text-zinc-900 font-mono tracking-tight">PAN-IND</p>
            <p className="text-zinc-500 font-mono uppercase text-[10px] sm:text-xs tracking-wider mt-2">Active Deployments</p>
          </motion.div>
          <motion.div variants={staggerItem} className="text-center">
            <p className="text-4xl sm:text-5xl font-black text-zinc-900 font-mono tracking-tight">24/7</p>
        ...
        <div className="pt-8 mb-24">
          ...
          >
            <span className="text-xs uppercase tracking-[0.2em] text-emerald-600 font-mono font-bold block mb-3">
              Leadership
            </span>
            <h3 className="text-3xl sm:text-5xl font-black tracking-tight text-zinc-900 uppercase">
              {language === 'hi' ? 'हमारे संस्थापकों से मिलें' : 'Meet Our Founders'}
            </h3>
            <p className="text-zinc-600 text-xs sm:text-sm max-w-md mx-auto mt-3 font-mono">
              {language === 'hi' 
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="text-center bg-zinc-50 border border-zinc-200 p-10 sm:p-14 rounded-3xl relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/5 to-transparent pointer-events-none" />
          <p className="text-2xl sm:text-4xl font-serif font-medium italic text-zinc-900 mb-8 max-w-3xl mx-auto leading-normal">
            "EarthFirm Sports Infra — From Blueprint to Glory."
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-10 text-xs sm:text-sm font-mono tracking-wider text-zinc-600">
        ...
        <div className="mt-16 flex justify-center">
          <button
            onClick={onBackToMain}
            className="flex items-center gap-2 px-6 py-3.5 bg-black text-white hover:bg-zinc-800 text-xs font-bold uppercase tracking-widest transition-all cursor-pointer shadow-lg active:scale-95"
          >
